...
glvm_parametrization(GlvSDModelAddons, "SD model addons",
    ...
    llm_path, SlvFile, "--llm_path", "alias of --llm. Deprecated.", SlvFile(SlvFile::IO::Read),
    llm_vision_path, SlvFile, "--llm_vision_path", "alias of --llm_vision. Deprecated.", SlvFile(SlvFile::IO::Read),
