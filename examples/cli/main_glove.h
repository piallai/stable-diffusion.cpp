...
glvm_parametrization(GlvSDParamsImageVideoInput, "Image/video input params",
                        init_img, SlvFile, "--init-img", "path to the init image", SlvFile(SlvFile::IO::Read),
...
glvm_parametrization(GlvSDParamsAdvanced, "Advanced params",
                        ...
                        prediction, Prediction, "--prediction", "prediction type override, one of [eps, v, edm_v, sd3_flow, flux_flow]", Prediction::Default,
...
glvm_parametrization(GlvSDModelAddons, "SD model addons",
    ...
    qwen2vl, SlvFile, "--qwen2vl", "path to the qwen2vl text encoder", SlvFile(SlvFile::IO::Read),
    qwen2vl_vision, SlvFile, "--qwen2vl_vision", "path to the qwen2vl vit", SlvFile(SlvFile::IO::Read),
    ...
    high_noise_diffusion_model, SlvFile, "--high-noise-diffusion-model", "path to the standalone high noise diffusion model", SlvFile(SlvFileExtensions({".gguf"}), SlvFile::IO::Read),
...
glvm_parametrization(GlvSDParamsHighNoise, "SD params (high noise)",
    ...
    high_noise_scheduler, Scheduler, "--high-noise-scheduler", "(high noise) denoiser sigma scheduler, one of [discrete, karras, exponential, ays, gits, smoothstep, sgm_uniform,\nsimple], default: discrete", Scheduler::discrete,
