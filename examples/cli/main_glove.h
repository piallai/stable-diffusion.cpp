...
glvm_parametrization(GlvSdModels, "Models",
    model, SlvFile, "--model@-m", "path to full model", SlvFile("", SlvFileExtensions({".safetensors", ".sft", ".ckpt"}), SlvFile::IO::Read),
    clip_l, SlvFile, "--clip_l", "path to the clip-l text encoder", SlvFile("", SlvFileExtensions({".safetensors", ".sft"}), SlvFile::IO::Read),
    clip_g, SlvFile, "--clip_g", "path to the clip-g text encoder", SlvFile("", SlvFileExtensions({".safetensors", ".sft"}), SlvFile::IO::Read),
    clip_vision, SlvFile, "--clip_vision", "path to the clip-vision encoder", SlvFile(SlvFile::IO::Read),
    t5xxl, SlvFile, "--t5xxl", "path to the t5xxl text encoder", SlvFile("", SlvFileExtensions({".safetensors", ".sft", ".gguf"}), SlvFile::IO::Read),
    llm, SlvFile, "--llm@--qwen2vl", "path to the llm text encoder. For example: (qwenvl2.5 for qwen-image, mistral-small3.2 for flux2, ...)", SlvFile("", SlvFileExtensions({".safetensors", ".sft", ".gguf"}), SlvFile::IO::Read),
...
#include "common/common.h" // for version_string()
